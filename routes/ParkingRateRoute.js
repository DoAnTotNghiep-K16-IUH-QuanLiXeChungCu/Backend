...
router.patch(
  ...
  ParkingRateController.GetAllParkingRates
);
...
router.put(
  "/CreateParkingRate",
  middleware.verifyToken,
  ParkingRateController.CreateParkingRate
);
...
router.post(
  "/UpdateParkingRate",
  middleware.verifyToken,
  ParkingRateController.UpdateParkingRate
);
...
router.patch(
  "/GetParkingRateById",
  middleware.verifyToken,
  ParkingRateController.GetParkingRateById
);
...
router.delete(
  "/DeleteParkingRate",
  middleware.verifyToken,
  ParkingRateController.DeleteParkingRate
);
