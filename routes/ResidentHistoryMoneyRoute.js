...
router.patch(
  ...
  ResidentHistoryMoneyController.GetAllResidentHistoryMoneys
);
...
router.post(
  ...
  middleware.verifyToken,
  ResidentHistoryMoneyController.CreateResidentHistoryMoney
);
...
router.put(
  ...
  middleware.verifyToken,
  ResidentHistoryMoneyController.UpdateResidentHistoryMoney
);
...
router.delete(
  ...
  middleware.verifyToken,
  ResidentHistoryMoneyController.DeleteResidentHistoryMoney
);
...
router.patch(
  ...
  middleware.verifyToken,
  ResidentHistoryMoneyController.GetResidentHistoryMoneyById
);
...
router.patch(
  ...
  middleware.verifyToken,
  ResidentHistoryMoneyController.GetMonthlyStatistics
);
...
router.patch(
  "/GetYearlyStatistics",
  middleware.verifyToken,
  ResidentHistoryMoneyController.GetYearlyStatistics
);
...
router.patch(
  ...
  middleware.verifyToken,
  ResidentHistoryMoneyController.FilterResidentHistoryMoneys
);
...
router.patch(
  ...
  middleware.verifyToken,
  ResidentHistoryMoneyController.CheckResidentHistoryMoneys
);
router.patch(
  "/GetResidentHistoryMoneysLatesbyRFIDCard",
  middleware.verifyToken,
  ResidentHistoryMoneyController.GetResidentHistoryMoneysLatesbyRFIDCard
);
router.patch(
