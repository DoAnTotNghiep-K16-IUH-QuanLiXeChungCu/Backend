...
router.patch(
  ...
  UserShiftController.GetAllUserShifts
);
...
router.post(
  "/CreateUserShift",
  middleware.verifyToken,
  UserShiftController.CreateUserShift
);
...
router.put(
  "/UpdateUserShift",
  middleware.verifyToken,
  UserShiftController.UpdateUserShift
);
...
router.delete(
  "/DeleteUserShift",
  middleware.verifyToken,
  UserShiftController.DeleteUserShift
);
...
router.patch(
  ...
  middleware.verifyToken,
  UserShiftController.GetUserShiftsByUserIdAndDateRange
);
...
router.patch(
  "/FilterUserShift",
  middleware.verifyToken,
  UserShiftController.FilterUserShift
);
...
router.patch(
  ...
  middleware.verifyToken,
  UserShiftController.GetUserShiftsByUserIdAndShiftIdAndDateTime
);
